          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition">
            ...
            <div className="p-5">
              <div className="flex justify-between items-center mb-2">
                <span className="text-xs font-medium text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full">Woodworking</span>
                <span className="text-xs text-gray-500">July 25, 2023</span>
              </div>
              <h3 className="font-bold text-xl mb-2">Hand-Carved Spoon Making</h3>
              <p className="text-gray-600 mb-4">Learn traditional Scandinavian techniques for carving functional and beautiful wooden spoons with master woodworker Erik Johansson.</p>
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium">2 hours • $45</span>
                <Link href="/workshop/hand-carved-spoons" className="text-indigo-600 font-medium hover:text-indigo-700">
                  Register →
                </Link>
              </div>
            </div>
